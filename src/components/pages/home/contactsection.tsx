...
export default function ContactSection() {
  return (
    <section className="max-w-screen-2xl mx-auto min-h-screen bg-black flex flex-col justify-center sm:px-16 lg:px-30 py-20">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white my-16">Get in Touch</h1>
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <div className="w-full h-80 lg:h-[500px] rounded-lg overflow-hidden shadow-lg">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3579.5799927684566!2d72.85624397498299!3d19.28609298196224!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b048ed46be7d%3A0x69f0472d4346465b!2sI-ZAB%20Academy!5e1!3m2!1sen!2sin!4v1747151490767!5m2!1sen!2sin"
            width="100%"
            height="100%"
            className="border-0"
            allowFullScreen

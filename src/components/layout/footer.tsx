...
export default function Footer() {
  return (
    <footer className="bg-black text-gray-300 border-t border-gray-800  w-full ">
      <div className="w-full mx-auto sm:px-16 lg:px-30 pt-12 flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0">
        ...
        <div className="w-full md:w-1/3 flex flex-col items-start">
          ...
          <div className="flex w-full">
            <input
              ...
              className="flex-1 px-4 py-2 bg-gray-800 text-gray-100 placeholder-gray-500 rounded-l-lg focus:outline-none"
            />
            <button className="px-4 bg-yellow-500 text-black font-semibold rounded-r-lg hover:bg-yellow-600 transition-colors duration-200">
              Subscribe
            </button>
          </div>
        </div>
          ...
          <div className="flex justify-end space-x-4 mt-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.268c-.966 0-1.75-.785-1.75-1.75s.784-1.75 1.75-1.75 1.75.785 1.75 1.75-.784 1.75-1.75 1.75zm13.5 11.268h-3v-5.604c0-1.337-.025-3.059-1.866-3.059-1.867 0-2.153 1.459-2.153 2.966v5.697h-3v-10h2.881v1.368h.041c.402-.761 1.381-1.562 2.844-1.562 3.041 0 3.604 2.005 3.604 4.611v5.583z" />
              </svg>
            </a>
            <a
              href="#"
